...
organization_fullName_reduce <- organization_fullName[1:20]
scores <- outer(organization_fullName_reduce, organization_fullName_reduce, vectorised_match)
rownames(scores) <- organization_fullName_reduce
colnames(scores) <- organization_fullName_reduce
scores
# those with >1 scores are the same organization.
